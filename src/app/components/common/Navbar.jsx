...
const Navbar = ({ from, setIsFilterOpen, isFilterOpen }) => {
  ...
  const { categories, brands, getCategories, getBrands } = useAppContext();
      ...
      <div className="flex justify-between px-4 md:px-16 bg-[#002967] fixed h-20 w-full shadow shadow-gray-600 z-20">
        ...
        <div className="w-[60%] hidden md:flex">
          <input
            ...
            name=""
            id=""
            className="px-4 py-3 text-[12px] self-center w-full rounded-[16px]"
          />
          <button className="px-4 py-3 text-[12px] self-center font-bold text-[#002967]  border border-[#F7941E]  rounded-[16px] bg-[#F7941E] w-[120px] ml-[-28px]">
            Search
          </button>
        </div>
      ...
      {categoryNav && (
        <div className="mt-20 bg-white px-4 md:px-16 flex justify-between fixed h-16 w-full shadow shadow-gray-200 z-20">
          ...
          <div className="w-[60%] flex md:hidden">
            ...
            />
            <button className="px-3 py-2 text-[12px] self-center border border-[#F7941E] font-bold text-[#002967] rounded-[16px] bg-[#F7941E] w-[120px] ml-[-38px]">
              Search
            </button>
          </div>
        </div>
